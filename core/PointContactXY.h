...
class GeFiCa::PointContactXY : public GeFiCa::RZ
{
  public:
    double XUpperBound,XLowerBound,YUpperBound,YLowerBound,PointBegin,PointEnd;//bounds for X and Y and point start and end
   public :
     PointContactXY(int ix,int iy) : RZ(ix,iy), XUpperBound(1),XLowerBound(0),YUpperBound(1),YLowerBound(0), PointBegin(0.4),PointEnd(0.6){};
